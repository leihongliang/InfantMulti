...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(9, 9, 561, 91))
        self.groupBox.setMinimumSize(QtCore.QSize(561, 91))
        self.groupBox.setAlignment(QtCore.Qt.AlignCenter)
        self.groupBox.setObjectName("groupBox")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 40, 541, 51))
        ...
        self.label_video = QtWidgets.QGraphicsView(self.centralwidget)
        self.label_video.setGeometry(QtCore.QRect(10, 130, 711, 531))
        self.label_video.setMinimumSize(QtCore.QSize(561, 531))
        self.label_video.setObjectName("label_video")
        self.recognition_results_label = QtWidgets.QLabel(self.centralwidget)
        self.recognition_results_label.setGeometry(QtCore.QRect(790, 370, 331, 41))
        ...
        self.statistics_results_label.setGeometry(QtCore.QRect(800, 50, 331, 41))
        ...
        self.data_statistic_show.setGeometry(QtCore.QRect(740, 110, 501, 261))
        ...
        self.recognition_result.setGeometry(QtCore.QRect(740, 400, 521, 241))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.data_statistic_show.setText(_translate("MainWindow", "TextLabel"))
