...
from UI_test_realtime.inference_gui import infantDetection, infantDetectionrealtime, moderl_load, center_crop
    ...
    def run(self):
        ...
        while self.threadFlag:
            ...
            if self.realtimeFlag == 1:
                print("video_work_checkpiont1")
                self.changeFlag = 0
                self.cap = cv2.VideoCapture(self.CAM_NUM)

            if self.video_path != "" or self.realtimeFlag == 1:
    ...
    def play(self):
        ...
        while self.threadFlag:
            ...
            if self.realtimeFlag:
                ...
                class_result = ''
                while flag:
                    frame, class_result, prob_result = infantDetectionrealtime(model, self.clip, cap,
                                                                               self.prob_result, class_result)
                    ...
                    frame_s += 1
                    print(frame_s % 16 == 0)
                    if last_result != this_result and frame_s % 15 == 0:
